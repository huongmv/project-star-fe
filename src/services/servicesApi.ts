...
// import { USER, TOKEN, SETTING_NAVBAR_MODE, SETTING_SIDEBAR_MODE, SETTING_BREAKCRUMB, USER_LOGINED, USER_RANK } from '@/const/cookie'
...
//         // app.axios.defaults.headers.common['Access-Control-Allow-Origin'] = 'Origin'
...
//         }
//         // if (user !== null && tokenCookies != null) {
//         if (user !== null) {
